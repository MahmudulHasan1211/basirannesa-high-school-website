      ...
      <div className="  w-[97%] mx-auto grid grid-cols-2 gap-5 p-5">
        <div className="bg-[#edf0f2] shadow-md p-6 rounded-md">
          ...
          <div className="flex flex-col items-center justify-center  gap-6">
            ...
            <div className="flex-1">
              <p className="text-justify text-[16px] leading-relaxed">
                ...
                প্রযুক্তিজ্ঞান-সম্পন্ন নাগরিক হিসেবেও গড়ে উঠতে পারে। আমাদের মূল
                লক্ষ্য হলো মানসম্মত ও সময়োপযোগী শিক্ষার পাশাপাশি শিক্ষার্থীদের
                তথ্যপ্রযুক্তিতে দক্ষ করে গড়ে তোলা, তাদের মধ্যে শৃঙ্খলা, সততা ও
                নৈতিক মূল্যবোধের চর্চা নিশ্চিত করা, এবং একটি নিরাপদ, সুস্থ ও
                উৎসাহব্যঞ্জক শিক্ষাব্যবস্থা গড়ে তোলা। আমি বিশ্বাস করি, শিক্ষক,
                অভিভাবক ও শিক্ষার্থীদের সম্মিলিত চেষ্টায় আমরা এই লক্ষ্য অর্জনে
                সফল হবো এবং সমাজের জন্য গড়ে তুলতে পারবো একঝাঁক আলোকিত মানুষ
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 text-right text-sm">
            ...
            <p>প্রধান শিক্ষকে, বছিরননেছা উচ্চ বিদ্যালয়</p>
          </div>
        </div>
